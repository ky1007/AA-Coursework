...
## THIS WILL NOT WORK: CardinalityViolation:
...
## THIS IS AN ALTERNATE SOLUTION THAT WOULD WORK
def neighbors_of_certain_b_countries
  # List the name and continent of countries in the continents containing
  # 'Belize', 'Belgium'.
  execute(<<-SQL)
...
def sparse_continents
  ...
  # population.  # Hint: Sometimes rewording the problem can help you see the solution.
